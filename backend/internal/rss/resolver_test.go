...
func TestResolveFeedURLCore(t *testing.T) {
	runResolveCases(t, []resolveCase{
		...
		{name: "existing_rsshub_weibo_url", input: "http://rsshub:1200/weibo/user/1195230310", rsshubBase: "http://rsshub:1200/", want: "http://rsshub:1200/weibo/user/1195230310/displayComments=1"},
