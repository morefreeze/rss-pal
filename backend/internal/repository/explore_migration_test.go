...
func TestMigration038_ExploreSchema(t *testing.T) {
	...
	for _, constraint := range []struct{ table, name, target string }{
		...
		{"explore_related_tasks", "explore_related_tasks_provider_id_fkey", "explore_registry_providers"},
		{"explore_related_tasks", "explore_related_tasks_run_id_fkey", "explore_fetch_runs"},
